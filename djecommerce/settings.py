...
SECRET_KEY = '9p4xjo$7%9hk0xz15t^b&^e^c)ns1-^!i^0x8!9n-8^3cdvn^$'
...
INSTALLED_APPS = [
    ...
    # not included by default, it was included for allauth package
    ...
    # crispy forms
    'crispy_forms',
    # adds list of countries to forms
    'django_countries',
...
# change default static files location
STATICFILES_DIRS = [
